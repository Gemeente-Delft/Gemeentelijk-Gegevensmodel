...
Je vindt de DDL's voor de genoemde databases in de directory  ['ddl' in de release-directory](https://github.com/Gemeente-Delft/Gemeentelijk-Gegevensmodel/tree/master/v2.5.0/ddl%20(early%20release)).  
...
1. Download het bestand [CodegeneratieTemplates.xml((https://github.com/Gemeente-Delft/Gemeentelijk-Gegevensmodel/blob/master/v2.5.0/CodegeneratieTemplates.xml))
