...
* **Onderwijsroute**: <font color="#0e0e0e">De </font><font color="#0e0e0e"><b>Onderwijsroute</b></font><font color="#0e0e0e"> is &#233;&#233;n van de drie leerroutes binnen het inburgeringsstelsel, bedoeld voor leerbare en jonge inburgeringsplichtigen die zich willen voorbereiden op het volgen van een opleiding in het mbo, hbo of hoger onderwijs in Nederland.</font>
...
??? info "Kenmerken Model Boolean"
    ...
    | id | EAID_50a5ce03_da11_4621_a477_89b6c544aa4f |
    | domein_iv3 |  |
    | domein_dcat |  |
    | gemma_naam |  |
    | gemma_type |  |
...
??? info "Kenmerken Model Boolean"
    ...
    | created | 2025-03-26 11:13:35 |
    | modified | 2025-03-26 16:14:54 |
    | id | EAID_a71f0cf1_a29b_4680_8086_9c0ab6c729f8 |
    | domein_iv3 |  |
    | domein_dcat |  |
    | gemma_naam |  |
    | gemma_type |  |
...
??? info "Kenmerken Model CodeNiveauOpleiding"
    ...
    | id | EAID_889e0947_84f1_4106_b6d8_e218b9b2f2f7 |
    | domein_iv3 |  |
    | domein_dcat |  |
    | gemma_naam |  |
    | gemma_type |  |
...
??? info "Kenmerken Model Doelgroep"
    ...
    | id | EAID_209ed43d_3ae1_46c4_8f85_8e715e105a2f |
    | domein_iv3 |  |
    | domein_dcat |  |
    | gemma_naam |  |
    | gemma_type |  |
...
* **Financien**: <Geen Definities>
* **Verslaving**: <Geen Definities>
* **Zorgtaken**: <Geen Definities>
* **Justitie**: <Geen Definities>
* **Taal**: <Geen Definities>
* **Digitale vaardigheden**: <Geen Definities>
* **Lichaamelijke gezondheid**: <Geen Definities>
* **Psychische gezondheid**: <Geen Definities>
* **Woonsituatie**: <Geen Definities>
...
* **Toegestaan**: <Geen Definities>
* **NietToegestaan**: <Geen Definities>
...
* **Betaald Werken**: <Geen Definities>
* **Ondernemen**: <Geen Definities>
* **Opleiding met studiefinanciering**: <Geen Definities>
* **Betaal werken naar vermogen**: <Geen Definities>
* **Werkfit worden**: <Geen Definities>
* **Maatschappelijk fit worden**: <Geen Definities>
...
* **Zwangerschap**: <Geen Definities>
* **Fysieke reden**: <Geen Definities>
* **Heeft competentie**: <Geen Definities>
* **Overig**: <Geen Definities>
...
* **Betaald werken**: <Geen Definities>
* **Betaald werken naar vermogen**: <Geen Definities>
* **Betaald werken met een opleiding**: <Geen Definities>
* **Werknemersvaardigheden ontwikkelen**: <Geen Definities>
* **Werkervaring opdoen**: <Geen Definities>
* **Taalvaardigheden opdoen**: <Geen Definities>
* **Ondernemen**: <Geen Definities>
* **Opleiding volgen**: <Geen Definities>
* **Vrijwilligerswerk**: <Geen Definities>
* **Passende dagbesteding hebben**: <Geen Definities>
...
* **Nooit aanwezig**: <Geen Definities>
* **Wel/niet aanwezig**: <Geen Definities>
* **Altijd aanwezig**: <Geen Definities>
...
* **ik weet welke opleiding past bij mijn mogelijkheden**: <Geen Definities>
* **ik ben gestart met een BBL opleiding (werken en leren)**: <Geen Definities>
* **ik volg een opleiding naast mijn parttime betaalde baan**: <Geen Definities>
...
* **ik weet welk werk bij mijn past**: <Geen Definities>
* **ik weet hoeveel uur ik kan werken**: <Geen Definities>
* **ik heb werk gevonden waarmee ik uit de bijstand ga**: <Geen Definities>
* **ik ben gestart met werken en behoud mijn werk succesvol**: <Geen Definities>
* **ik heb urenuitbreiding gekregen**: <Geen Definities>
* **ik weet wat mijn kwaliteiten zijn**: <Geen Definities>
...
* **ik kan omgaan met computer, smartphone en tablet en kan zelfstandig mailen en zoeken op internet**: <Geen Definities>
* **ik heb voldoende digitale vaardigheden om een stap te zetten richting de arbeidsmarkt**: <Geen Definities>
...
* **ik heb een netwerk waarmee ik sociale contacten heb**: <Geen Definities>
* **ik heb vertrouwen in mijzelf**: <Geen Definities>
...
* **ik heb overzicht over mijn financiele situatie en het lukt mij om rond te komen**: <Geen Definities>
* **ik ben gestart met de hulp voor mijn schulden**: <Geen Definities>
* **ik heb geen financiele belemmeringen om aan het werk te gaan**: <Geen Definities>
* **ik heb hulp bij het regelen van mijn financien**: <Geen Definities>
...
* **ik weet wat mijn mogelijkheden zijn met mijn justitiele verleden**: <Geen Definities>
* **ik heb mijn penitentair programma succesvol afgerond**: <Geen Definities>
...
* **ik heb hulp gevraagd voor mijn lichamelijke klachten**: <Geen Definities>
* **ik ben onder behandeling voor mijn lichamelijke klachten**: <Geen Definities>
* **ik weet wat mijn mogelijkheden zijn ondanks mijn lichamelijke klachten**: <Geen Definities>
* **ik heb een beoordeling arbeidsvermogen aangevraagd bij het UWV**: <Geen Definities>
* **ik heb vertrouwen in mijzelf**: <Geen Definities>
...
* **ik weet of ik in aanmerking kom om te ondernemen vanuit bijstand**: <Geen Definities>
* **ik heb een ondernemingsplan geschreven**: <Geen Definities>
* **ik heb mijn BBZ aanvraag ingediend**: <Geen Definities>
* **Mijn BBZ aanvraag is toegekend**: <Geen Definities>
...
* **ik weet welke opleiding past bij mijn mogelijkheden**: <Geen Definities>
* **ik ben gestart met een opleiding**: <Geen Definities>
...
* **ik ben gestart met een passende dagbesteding**: <Geen Definities>
...
* **ik heb hulp gevraagd voor mijn psychische klachten**: <Geen Definities>
* **ik ben onder behandeling voor mijn psychische klachten**: <Geen Definities>
* **ik weet wat mijn mogelijkkheden zijn ondanks de psychische klachten**: <Geen Definities>
* **ik heb een beoordeling arbeidsvermogen aangevraagd bij het UWV**: <Geen Definities>
* **ik heb vertrouwen in mijzelf**: <Geen Definities>
...
* **ik weet wat mijn Nederlands taalniveau is**: <Geen Definities>
* **ik beheers de Nederlandse taal voldoende om een volgende stap te kunnen zetten**: <Geen Definities>
* **ik beheers de Nederlandse taal op het voor mij hoogst haalbare niveau**: <Geen Definities>
...
* **ik beheers de nederlandse taal voldoende om aan het werk te gaan of te ondernemen**: <Geen Definities>
...
* **ik heb hulp gevraagd voor mijn verslavingsproblematiek**: <Geen Definities>
* **ik ben onder behandeling voor mijn verslavingsproblematiek**: <Geen Definities>
* **ik weet wat mijn mogelijkheden zijn ondanks de verslavingsproblematiek**: <Geen Definities>
* **Ik heb vertrouwen in mijzelf**: <Geen Definities>
...
* **ik ben gestart met vrijwilligerswerk**: <Geen Definities>
...
* **ik heb werkervaring opgedaan in een functie**: <Geen Definities>
* **ik weet hoeveel uren ik kan werken**: <Geen Definities>
* **ik heb opgebouwd in het aantal uren wat ik kan werken**: <Geen Definities>
* **ik weet wat mijn kwaltiteiten zijn**: <Geen Definities>
...
* **ik weet wat er van mijn verwacht wordt als werknemer**: <Geen Definities>
* **ik heb een werkritme**: <Geen Definities>
* **ik weet hoeveel uren ik kan werken**: <Geen Definities>
* **ik heb opgebouwd in het aantal uren wat ik kan werken**: <Geen Definities>
* **ik weet wat mijn kwaliteiten zijn**: <Geen Definities>
...
* **ik heb hulp gevraagd om mijn woonsituatie te verbeteren**: <Geen Definities>
* **ik heb ervoor gezorgd dat mijn woonsituatie verbeterd**: <Geen Definities>
...
* **ik heb kinderopvang voor mijn kinderen**: <Geen Definities>
* **ik kan mijn zorgtaken (mantelzorg) overdragen aan anderen**: <Geen Definities>
* **ik weet hoe ik mijn zorgtaken kan combineren met een baan, opleiding of andere activiteit**: <Geen Definities>
* **ik weet of ik (vanuit PGB) betaald kan krijgen voor mijn werkzaamheden als mantelzorger**: <Geen Definities>
* **ik krijg betaald voor mijn werkzaamheden als mantelzorger (vanuit PGB)**: <Geen Definities>
...
* **Onderwijsroute**: <Geen Definities>
* **B1-route**: <Geen Definities>
* **Z-route**: <Geen Definities>
...
* **AsielStatushouder**: <Geen Definities>
* **GezinsMigrant**: <Geen Definities>
* **OverigeMigrant**: <Geen Definities>
