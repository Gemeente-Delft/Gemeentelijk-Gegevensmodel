...
| objecttypecode | typeObjectcode | Een code waarmee het objecttype van een object wordt<br>aangegeven. |
...
| valutasoort | Valutasoort | Aanduiding van de valutasoort. |
...
| Attribute | Datatype | Description |
| :--- | :--- | :--- |
| kadastraleGemeentecode | AkrKadastraleGemeentecode | AKR code voor de kadastrale gemeente. |
...
| Attribute | Datatype | Description |
| :--- | :--- | :--- |
| plaatsingspunt | Point | Coördinaten voor de locatie waar het label moet worden getoond. |
...
??? info "Kenmerken Model typeObjectcode"
    ...
    | id | EAID\_2b842cae\_ef56\_43ec\_a033\_3d0d7d368eea |
    | domein_iv3 |  |
    | domein_dcat |  |
    | gemma_naam |  |
    | gemma_type |  |
