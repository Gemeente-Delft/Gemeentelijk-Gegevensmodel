...
## Inleiding
> **Definitie Terug- en invordering:** 
>
> Geen definitie

Het model 'Terug- en invordering' kent de volgende objecttypen:
...
Het model 'Terug- en invordering' heeft de volgende kenmerken:

| Kenmerk | Waarde |
| :--- | :------ |
| name | Terug- en invordering |
| toelichting |  |
| synoniemen |  |
| uri |  |
| bron |  |
...
## Objecttypen Terug- en invordering
