...
1. Download het bestand [GGM XMI-bestand geschikt voor Enterprise Architect 15, 16 en 17](https://github.com/Gemeente-Delft/Gemeentelijk-Gegevensmodel/blob/master/v2.4.0/Gemeentelijk%20Gegevensmodel%20XMI2.1.xml) en sla deze lokaal op
...
1\. Download het bestand [Gemeentelijk Gegevensmodel XMI2.1](https://github.com/Gemeente-Delft/Gemeentelijk-Gegevensmodel/blob/master/v2.4.0/Gemeentelijk%20Gegevensmodel%20XMI2.1.xml)
