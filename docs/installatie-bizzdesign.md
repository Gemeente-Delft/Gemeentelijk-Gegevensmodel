...
1\. Download het bestand [Gemeentelijk Gegevensmodel XMI2.1.2](Gemeentelijk%20Gegevensmodel%20XMI2.1.2.xml)
...
4\. Selecteer het UML-model, en open de query-editor met ctrl-Q. Kopieer de inhoud van het scriptbestand [UML XMI import Bizzdesign.txt](UML%20XMI%20import%20Bizzdesign.txt) in de query-editor. Sla eventueel het script op in het model.
