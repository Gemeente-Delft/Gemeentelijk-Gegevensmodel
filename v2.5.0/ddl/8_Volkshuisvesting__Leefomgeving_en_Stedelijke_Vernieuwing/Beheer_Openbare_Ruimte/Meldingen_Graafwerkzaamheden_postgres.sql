...
CREATE TABLE OPBREKING (
    OPBREKING_ID VARCHAR(255) PRIMARY KEY
);

CREATE TABLE MOOR_MELDING (
    MOOR_MELDING_ID VARCHAR(255) PRIMARY KEY,
        ADRESAANDUIDING VARCHAR(255),
        BETREFT_OPBREKING_ID VARCHAR(255),
        BETREFT_PROCES_VERBAAL_MOOR_MELDING_ID VARCHAR(255),
        ...
        PUBLICEREN BOOLEAN,
        STARTTIJD TIMESTAMP,
        VERPLICHT_TOT_OMGEVINGSVERGUNNING_ID VARCHAR(255),
        WEGBEHEERDER VARCHAR(80)
);

CREATE TABLE PROCES_VERBAAL_MOOR_MELDING (
    PROCES_VERBAAL_MOOR_MELDING_ID VARCHAR(255) PRIMARY KEY,
        DATUM DATE,
        GOEDKEURING BOOLEAN,
...
CREATE TABLE MEDEWERKER (
    MEDEWERKER_ID VARCHAR(255) PRIMARY KEY,
        ...
        TELEFOONNUMMER VARCHAR(20),
        VERLEENT_PROCES_VERBAAL_MOOR_MELDING_ID VARCHAR(255),
...
CREATE TABLE UITVOERDER_GRAAFWERKZAAMHEDEN (
    RECHTSPERSOON_ID VARCHAR(255) PRIMARY KEY,
        DOET_MOOR_MELDING_ID VARCHAR(255),
        MAAKT_OPBREKING_ID VARCHAR(255)
);
