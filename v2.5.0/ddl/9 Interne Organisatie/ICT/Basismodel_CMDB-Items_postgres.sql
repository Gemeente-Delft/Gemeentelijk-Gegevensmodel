CREATE TABLE KOPPELING (
    ...
    DIRECT BOOLEAN,
    LINK_NAAR_LINKBAAR_CMDB_ITEM_ID INTEGER,
    TOELICHTING TEXT
);
...
CREATE TABLE CMDB_ITEM_ (
    CMDB_ITEM__ID INTEGER PRIMARY KEY,
    BESCHRIJVING TEXT,
    HEEFT_CHANGELOG_LOG_ID INTEGER,
    NAAM VARCHAR(255)
);
...
CREATE TABLE APPLICATIE (
    ...
    GUID VARCHAR(255),
    HEEFT_LEVERANCIER_LEVERANCIER_ID INTEGER,
    HEEFT_NOTITIES_NOTITIE_ID INTEGER,
    HEEFT_PACKAGES_PACKAGE_ID INTEGER,
    HEEFT_VERSIES_VERSIE_ID INTEGER,
    NAAM VARCHAR(255),
    OMSCHRIJVING TEXT,
...
CREATE TABLE DATABASE (
    ...
    OTAP BOOLEAN,
    SERVER_VAN_DATABASE_SERVER_ID INTEGER,
    VLAN VARCHAR(255)
);
