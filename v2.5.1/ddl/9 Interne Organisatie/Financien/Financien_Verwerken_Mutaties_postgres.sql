CREATE TABLE APPLICATIE (
    ...
    GUID VARCHAR(255),
    HEEFT_HERKOMST_BATCH_ID INTEGER,
    NAAM VARCHAR(255),
    OMSCHRIJVING TEXT,
...
CREATE TABLE HOOFDREKENING (
    ...
    HEEFT_SUBREKENING_ID INTEGER,
    HEEFT_WERKORDER_ID INTEGER,
    NAAM VARCHAR(80),
    NUMMER VARCHAR(255),
...
CREATE TABLE BANKAFSCHRIFT (
    ...
    DATUM DATE,
    HEEFT_BANKAFSCHRIFTREGEL_ID INTEGER,
    NUMMER VARCHAR(255)
);
...
CREATE TABLE BANKREKENING (
    ...
    NAAR_BETALING_ID INTEGER,
    NUMMER VARCHAR(255),
    TENNAAMSTELLING VARCHAR(80),
    VAN_BETALING_ID INTEGER
);
