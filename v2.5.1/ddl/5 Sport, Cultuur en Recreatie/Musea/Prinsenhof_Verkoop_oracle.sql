...
CREATE TABLE KP_ENTRKRT_PRDCT (
    KP_ENTRKRT_PRDCT_ID NUMBER PRIMARY KEY,
    ENTREEKAART_ID NUMBER,
    PRODUCT_ID NUMBER
);

CREATE TABLE KP_BLVRKP_ENTRKRT_BLVRKP (
    KP_BLVRKP_ENTRKRT_BLVRKP_ID NUMBER PRIMARY KEY,
    BALIEVERKOOP_ENTREEKAART_ID NUMBER,
    BALIEVERKOOP_ID NUMBER
);
