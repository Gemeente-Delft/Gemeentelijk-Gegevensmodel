...
CREATE TABLE OPLOSSINGSSOORT (
    OPLOSSINGSSOORT_ID INTEGER PRIMARY KEY,
    SOORT_ENUM_ID INTEGER
);

CREATE TABLE BEGELEIDINGSSOORT (
    BEGELEIDINGSSOORT_ID INTEGER PRIMARY KEY,
    SOORT_ENUM_ID INTEGER
);
...
CREATE TABLE OPLOSSING (
    ...
    EINDDATUM DATE,
    SOORT_ENUM_ID INTEGER,
    SOORT_OPLOSSINGSSOORT_ID INTEGER,
    STARTDATUM DATE,
    VTLB VARCHAR(255)
);

CREATE TABLE KP_SCHLDHLPRGNST_BGLDNGSSRT (
    KP_SCHLDHLPRGNST_BGLDNGSSRT_ID INTEGER PRIMARY KEY,
    SCHULDHULPORGANISATIE_ID INTEGER,
    BEGELEIDINGSSOORT_ID INTEGER
);
...
CREATE TABLE KP_SCHLDHLPRGNST_CNTCTPRSN (
    KP_SCHLDHLPRGNST_CNTCTPRSN_ID INTEGER PRIMARY KEY,
    SCHULDHULPORGANISATIE_ID INTEGER,
    CONTACTPERSOON_ID INTEGER
);

CREATE TABLE KP_SCHLDHLPRGNST_OPLSSNGSSRT (
    KP_SCHLDHLPRGNST_OPLSSNGSSRT_ID INTEGER PRIMARY KEY,
    SCHULDHULPORGANISATIE_ID INTEGER,
    OPLOSSINGSSOORT_ID INTEGER
);
...
CREATE TABLE BEGELEIDING (
    ...
    EINDDATUM DATE,
    SOORT_BEGELEIDINGSSOORT_ID INTEGER,
    SOORT_ENUM_ID INTEGER,
    STARTDATUM DATE
);
