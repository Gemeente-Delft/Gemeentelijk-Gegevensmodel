...
CREATE TABLE KP_SCHLDHLPRGNST_NTNTRLJKPRSN (
    KP_SCHLDHLPRGNST_NTNTRLJKPRSN_ID NUMBER PRIMARY KEY,
    SCHULDHULPORGANISATIE_ID NUMBER,
...
ALTER TABLE KP_SCHLDHLPRGNST_NTNTRLJKPRSN ADD CONSTRAINT FK_KP_SCHLDHLPRGNST_NTNTRLJKPRSN_1 FOREIGN KEY (SCHULDHULPORGANISATIE_ID) REFERENCES SCHULDHULPORGANISATIE (NIETNATUURLIJKPERSOON_ID);
-- SCHULDHULPORGANISATIE (many-to-many junction, Connector_ID: 968)

ALTER TABLE KP_SCHLDHLPRGNST_NTNTRLJKPRSN ADD CONSTRAINT FK_KP_SCHLDHLPRGNST_NTNTRLJKPRSN_2 FOREIGN KEY (NIETNATUURLIJKPERSOON_ID) REFERENCES NIETNATUURLIJKPERSOON (NIETNATUURLIJKPERSOON_ID);
-- NIETNATUURLIJKPERSOON (many-to-many junction, Connector_ID: 968)
...
ALTER TABLE BEGELEIDINGSSOORT ADD CONSTRAINT FK_BEGELEIDINGSSOORT_SOORT_ENUM_ID FOREIGN KEY (SOORT_ENUM_ID_ENUMBEGELEIDINGSSOORT_ENUM_ID) REFERENCES ENUMBEGELEIDINGSSOORT_ENUM (ENUMBEGELEIDINGSSOORT_ENUM_ID);
-- SOORT_ENUM_ID (1 to 1, Connector_ID: enum_ref)
...
ALTER TABLE OPLOSSINGSSOORT ADD CONSTRAINT FK_OPLOSSINGSSOORT_SOORT_ENUM_ID FOREIGN KEY (SOORT_ENUM_ID_ENUMSCHULDENSOORT_ENUM_ID) REFERENCES ENUMSCHULDENSOORT_ENUM (ENUMSCHULDENSOORT_ENUM_ID);
-- SOORT_ENUM_ID (1 to 1, Connector_ID: enum_ref)
