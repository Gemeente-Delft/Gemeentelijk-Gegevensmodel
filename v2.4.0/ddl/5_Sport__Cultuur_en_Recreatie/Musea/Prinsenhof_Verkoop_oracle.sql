...
CREATE TABLE KP_PRDCT (
    KP_PRDCT_ID VARCHAR2(255) PRIMARY KEY,
...
ALTER TABLE KP_PRDCT ADD CONSTRAINT FK_KP_PRDCT_1 FOREIGN KEY (PRODUCT_ID) REFERENCES PRODUCT (PRODUCT_ID);
-- PRODUCT (many-to-many junction, Connector_ID: 1112)

ALTER TABLE KP_PRDCT ADD CONSTRAINT FK_KP_PRDCT_2 FOREIGN KEY (PRODUCTGROEP_ID) REFERENCES PRODUCTGROEP (PRODUCTGROEP_ID);
-- PRODUCTGROEP (many-to-many junction, Connector_ID: 1112)

ALTER TABLE KP_PRDCT ADD CONSTRAINT FK_KP_PRDCT_1 FOREIGN KEY (PRODUCT_ID) REFERENCES PRODUCT (PRODUCT_ID);
-- PRODUCT (many-to-many junction, Connector_ID: 1114)

ALTER TABLE KP_PRDCT ADD CONSTRAINT FK_KP_PRDCT_2 FOREIGN KEY (OMZETGROEP_ID) REFERENCES OMZETGROEP (OMZETGROEP_ID);
