...
CREATE TABLE BEGELEIDINGSSOORT (
    BEGELEIDINGSSOORT_ID VARCHAR(255) PRIMARY KEY,
        SOORT VARCHAR(255)
);
...
CREATE TABLE BEGELEIDING (
    BEGELEIDING_ID VARCHAR(255) PRIMARY KEY,
        EINDDATUM DATE,
        SOORT_BEGELEIDINGSSOORT_ID VARCHAR(255),
...
CREATE TABLE OPLOSSINGSSOORT (
    OPLOSSINGSSOORT_ID VARCHAR(255) PRIMARY KEY,
        SOORT VARCHAR(255)
);
...
CREATE TABLE OPLOSSING (
    OPLOSSING_ID VARCHAR(255) PRIMARY KEY,
        EINDDATUM DATE,
        SOORT_ENUM_ID VARCHAR(255),
        SOORT_OPLOSSINGSSOORT_ID VARCHAR(255),
        STARTDATUM DATE,
        VTLB VARCHAR(255)
);
...
CREATE TABLE KP_SCHLDHLPRGNST_BGLDNGSSRT (
    KP_SCHLDHLPRGNST_BGLDNGSSRT_ID VARCHAR(255) PRIMARY KEY,
    SCHULDHULPORGANISATIE_ID VARCHAR(255),
    BEGELEIDINGSSOORT_ID VARCHAR(255)
);

CREATE TABLE KP_SCHLDHLPRGNST_CNTCTPRSN (
    KP_SCHLDHLPRGNST_CNTCTPRSN_ID VARCHAR(255) PRIMARY KEY,
    SCHULDHULPORGANISATIE_ID VARCHAR(255),
    CONTACTPERSOON_ID VARCHAR(255)
);

CREATE TABLE KP_SCHLDHLPRGNST_OPLSSNGSSRT (
    KP_SCHLDHLPRGNST_OPLSSNGSSRT_ID VARCHAR(255) PRIMARY KEY,
    SCHULDHULPORGANISATIE_ID VARCHAR(255),
    OPLOSSINGSSOORT_ID VARCHAR(255)
);
