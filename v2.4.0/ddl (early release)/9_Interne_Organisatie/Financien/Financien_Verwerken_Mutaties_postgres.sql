CREATE TABLE APPLICATIE (
    APPLICATIE_ID VARCHAR(255) PRIMARY KEY,
        ...
        GUID VARCHAR(255),
        HEEFT_HERKOMST_BATCH_ID VARCHAR(255),
        NAAM VARCHAR(255),
        OMSCHRIJVING TEXT,
...
CREATE TABLE BANKAFSCHRIFT (
    BANKAFSCHRIFT_ID VARCHAR(255) PRIMARY KEY,
        DATUM DATE,
        HEEFT_BANKAFSCHRIFTREGEL_ID VARCHAR(255),
        NUMMER VARCHAR(255)
);

CREATE TABLE BANKAFSCHRIFTREGEL (
    BANKAFSCHRIFTREGEL_ID VARCHAR(255) PRIMARY KEY,
        BEDRAG DECIMAL(10,2),
        BIJ BOOLEAN,
        DATUM DATE,
        LEIDT_TOT_MUTATIE_ID VARCHAR(255),
        REKENINGVAN VARCHAR(255)
);

CREATE TABLE BANKREKENING (
    BANKREKENING_ID VARCHAR(255) PRIMARY KEY,
        BANK VARCHAR(80),
        HEEFT_BANKAFSCHRIFT_ID VARCHAR(255),
        NAAR_BETALING_ID VARCHAR(255),
        NUMMER VARCHAR(255),
        TENNAAMSTELLING VARCHAR(80),
        VAN_BETALING_ID VARCHAR(255)
);

CREATE TABLE BATCH (
    BATCH_ID VARCHAR(255) PRIMARY KEY,
        DATUM DATE,
        HEEFT_BATCHREGEL_ID VARCHAR(255),
        HEEFT_HERKOMST_EXTERNEBRON_ID VARCHAR(255),
        NUMMER VARCHAR(255),
        TIJD TIMESTAMP
);

CREATE TABLE BATCHREGEL (
    BATCHREGEL_ID VARCHAR(255) PRIMARY KEY,
        BEDRAG DECIMAL(10,2),
        DATUMBETALING DATE,
        LEIDT_TOT_MUTATIE_ID VARCHAR(255),
...
CREATE TABLE BETALING (
    BETALING_ID VARCHAR(255) PRIMARY KEY,
        BEDRAG DECIMAL(10,2),
        DATUMTIJD TIMESTAMP,
        KOMT_VOOR_OP_BANKAFSCHRIFTREGEL_ID VARCHAR(255),
        OMSCHRIJVING VARCHAR(200),
        VALUTA VARCHAR(255)
);

CREATE TABLE EXTERNEBRON (
    EXTERNEBRON_ID VARCHAR(255) PRIMARY KEY
);
...
CREATE TABLE FACTUUR (
    FACTUUR_ID VARCHAR(255) PRIMARY KEY,
        ...
        HEEFT_FACTUURREGEL_ID VARCHAR(255),
        OMSCHRIJVING VARCHAR(200),
        SCHRIJFT_OP_KOSTENPLAATS_ID VARCHAR(255)
);

CREATE TABLE FACTUURREGEL (
    FACTUURREGEL_ID VARCHAR(255) PRIMARY KEY,
        AANTAL VARCHAR(255),
...
CREATE TABLE HOOFDREKENING (
    HOOFDREKENING_ID VARCHAR(255) PRIMARY KEY,
        HEEFT_SUBREKENING_ID VARCHAR(255),
        HEEFT_WERKORDER_ID VARCHAR(255),
        NAAM VARCHAR(80),
        NUMMER VARCHAR(255),
        OMSCHRIJVING VARCHAR(200),
...
CREATE TABLE MUTATIE (
    MUTATIE_ID VARCHAR(255) PRIMARY KEY,
        BEDRAG DECIMAL(10,2),
        DATUM DATE,
        HEEFT_BETREKKING_OP_KOSTENPLAATS_ID VARCHAR(255),
        NAAR_HOOFDREKENING_ID VARCHAR(255),
        VAN_HOOFDREKENING_ID VARCHAR(255)
);

CREATE TABLE SUBREKENING (
    SUBREKENING_ID VARCHAR(255) PRIMARY KEY,
        NAAM VARCHAR(80),
        NUMMER VARCHAR(20),
        OMSCHRIJVING TEXT
);
...
CREATE TABLE WERKORDER (
    WERKORDER_ID VARCHAR(255) PRIMARY KEY,
        CODE VARCHAR(20),
