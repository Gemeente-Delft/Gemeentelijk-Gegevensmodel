CREATE TABLE APPLICATIE (
    CMDB_ITEM__ID VARCHAR2(255) PRIMARY KEY,
        APPLICATIEURL VARCHAR2(255),
        BEHEERSTATUS NUMBER,
        BELEIDSDOMEIN VARCHAR2(255),
        CATEGORIE_ENUM_ID VARCHAR2(255),
        GUID VARCHAR2(255),
        HEEFT_LEVERANCIER_LEVERANCIER_ID VARCHAR2(255),
        HEEFT_NOTITIES_NOTITIE_ID VARCHAR2(255),
        HEEFT_PACKAGES_PACKAGE_ID VARCHAR2(255),
        HEEFT_VERSIES_VERSIE_ID VARCHAR2(255),
        NAAM VARCHAR2(255),
        OMSCHRIJVING CLOB,
...
CREATE TABLE APPLICATIECATEGORIE_ENUM (
    APPLICATIECATEGORIE_ENUM_ID VARCHAR2(255) PRIMARY KEY,
    VALUE VARCHAR(255)
);
...
CREATE TABLE BEHEERSTATUS_ENUM (
    BEHEERSTATUS_ENUM_ID VARCHAR2(255) PRIMARY KEY,
    VALUE VARCHAR(255)
);
...
CREATE TABLE CMDB_ITEM_ (
    CMDB_ITEM__ID VARCHAR2(255) PRIMARY KEY,
        BESCHRIJVING CLOB,
        HEEFT_CHANGELOG_LOG_ID VARCHAR2(255),
        NAAM VARCHAR2(255)
);
...
CREATE TABLE DATABASE (
    CMDB_ITEM__ID VARCHAR2(255) PRIMARY KEY,
        ...
        OTAP VARCHAR2(255),
        SERVER_VAN_DATABASE_SERVER_ID VARCHAR2(255),
        VLAN VARCHAR2(255)
);
...
CREATE TABLE GEBRUIKERROL_835 (
    GEBRUIKERROL_835_ID VARCHAR2(255) PRIMARY KEY,
        ROL_ENUM_ID VARCHAR2(255)
);

CREATE TABLE GEBRUIKERROL_863_ENUM (
    GEBRUIKERROL_863_ENUM_ID VARCHAR2(255) PRIMARY KEY,
    VALUE VARCHAR(255)
);
...
CREATE TABLE KOPPELING (
    KOPPELING_ID VARCHAR2(255) PRIMARY KEY,
        BESCHRIJVING VARCHAR2(200),
        DIRECT NUMBER(1),
        LINK_NAAR_LINKBAAR_CMDB_ITEM_ID VARCHAR2(255),
        TOELICHTING CLOB
);

CREATE TABLE KP_APPLCT (
    KP_APPLCT_ID VARCHAR2(255) PRIMARY KEY,
    APPLICATIE_ID VARCHAR2(255),
...
CREATE TABLE LINKBAAR_CMDB_ITEM (
    CMDB_ITEM__ID VARCHAR2(255) PRIMARY KEY,
        LINK_VAN_KOPPELING_ID VARCHAR2(255)
);

CREATE TABLE LOG (
    LOG_ID VARCHAR2(255) PRIMARY KEY,
...
CREATE TABLE NOTITIE (
    NOTITIE_ID VARCHAR2(255) PRIMARY KEY,
        AUTEUR_MEDEWERKER_ID VARCHAR2(255),
        DATUM DATE,
        INHOUD CLOB
);

CREATE TABLE PACKAGE (
    PACKAGE_ID VARCHAR2(255) PRIMARY KEY,
        NAAM VARCHAR2(80),
        PROCES VARCHAR2(255),
...
CREATE TABLE PACKAGINGSTATUS_ENUM (
    PACKAGINGSTATUS_ENUM_ID VARCHAR2(255) PRIMARY KEY,
    VALUE VARCHAR(255)
);
...
CREATE TABLE SERVER (
    CMDB_ITEM__ID VARCHAR2(255) PRIMARY KEY,
        ...
        SERVERTYPE_ENUM_ID VARCHAR2(255),
        VLAN VARCHAR2(255)
);

CREATE TABLE SERVERTYPES_ENUM (
    SERVERTYPES_ENUM_ID VARCHAR2(255) PRIMARY KEY,
    VALUE VARCHAR(255)
);
...
CREATE TABLE VERSIE (
    VERSIE_ID VARCHAR2(255) PRIMARY KEY,
        AANTAL NUMBER,
...
ALTER TABLE KP_APPLCT ADD CONSTRAINT FK_KP_APPLCT_1 FOREIGN KEY (APPLICATIE_ID) REFERENCES APPLICATIE (CMDB_ITEM__ID);
-- APPLICATIE (many-to-many junction, Connector_ID: 628)

ALTER TABLE KP_APPLCT ADD CONSTRAINT FK_KP_APPLCT_2 FOREIGN KEY (MEDEWERKER_ID) REFERENCES MEDEWERKER (MEDEWERKER_ID);
-- MEDEWERKER (many-to-many junction, Connector_ID: 628)

ALTER TABLE KP_APPLCT ADD CONSTRAINT FK_KP_APPLCT_1 FOREIGN KEY (APPLICATIE_ID) REFERENCES APPLICATIE (CMDB_ITEM__ID);
-- APPLICATIE (many-to-many junction, Connector_ID: 646)

ALTER TABLE KP_APPLCT ADD CONSTRAINT FK_KP_APPLCT_2 FOREIGN KEY (DOCUMENT_ID) REFERENCES DOCUMENT (DOCUMENT_ID);
