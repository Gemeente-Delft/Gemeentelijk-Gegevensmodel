CREATE TABLE APPLICATIE (
    CMDB_ITEM__ID VARCHAR(255) PRIMARY KEY,
        APPLICATIEURL VARCHAR(255),
        BEHEERSTATUS INTEGER,
        BELEIDSDOMEIN VARCHAR(255),
        CATEGORIE_ENUM_ID VARCHAR(255),
        GUID VARCHAR(255),
        HEEFT_LEVERANCIER_LEVERANCIER_ID VARCHAR(255),
        HEEFT_NOTITIES_NOTITIE_ID VARCHAR(255),
        HEEFT_PACKAGES_PACKAGE_ID VARCHAR(255),
        HEEFT_VERSIES_VERSIE_ID VARCHAR(255),
        NAAM VARCHAR(255),
        OMSCHRIJVING TEXT,
...
CREATE TABLE APPLICATIECATEGORIE_ENUM (
    APPLICATIECATEGORIE_ENUM_ID VARCHAR(255) PRIMARY KEY,
    VALUE VARCHAR(255)
);
...
CREATE TABLE BEHEERSTATUS_ENUM (
    BEHEERSTATUS_ENUM_ID VARCHAR(255) PRIMARY KEY,
    VALUE VARCHAR(255)
);
...
CREATE TABLE CMDB_ITEM_ (
    CMDB_ITEM__ID VARCHAR(255) PRIMARY KEY,
        BESCHRIJVING TEXT,
        HEEFT_CHANGELOG_LOG_ID VARCHAR(255),
        NAAM VARCHAR(255)
);
...
CREATE TABLE DATABASE (
    CMDB_ITEM__ID VARCHAR(255) PRIMARY KEY,
        ...
        OTAP VARCHAR(255),
        SERVER_VAN_DATABASE_SERVER_ID VARCHAR(255),
        VLAN VARCHAR(255)
);
...
CREATE TABLE GEBRUIKERROL_835 (
    GEBRUIKERROL_835_ID VARCHAR(255) PRIMARY KEY,
        ROL_ENUM_ID VARCHAR(255)
);

CREATE TABLE GEBRUIKERROL_863_ENUM (
    GEBRUIKERROL_863_ENUM_ID VARCHAR(255) PRIMARY KEY,
    VALUE VARCHAR(255)
);
...
CREATE TABLE KOPPELING (
    KOPPELING_ID VARCHAR(255) PRIMARY KEY,
        BESCHRIJVING VARCHAR(200),
        DIRECT BOOLEAN,
        LINK_NAAR_LINKBAAR_CMDB_ITEM_ID VARCHAR(255),
        TOELICHTING TEXT
);

CREATE TABLE KP_APPLCT (
    KP_APPLCT_ID VARCHAR(255) PRIMARY KEY,
    APPLICATIE_ID VARCHAR(255),
...
CREATE TABLE LINKBAAR_CMDB_ITEM (
    CMDB_ITEM__ID VARCHAR(255) PRIMARY KEY,
        LINK_VAN_KOPPELING_ID VARCHAR(255)
);
...
CREATE TABLE NOTITIE (
    NOTITIE_ID VARCHAR(255) PRIMARY KEY,
        AUTEUR_MEDEWERKER_ID VARCHAR(255),
        DATUM DATE,
        INHOUD TEXT
);
...
CREATE TABLE PACKAGINGSTATUS_ENUM (
    PACKAGINGSTATUS_ENUM_ID VARCHAR(255) PRIMARY KEY,
    VALUE VARCHAR(255)
);
...
CREATE TABLE SERVER (
    CMDB_ITEM__ID VARCHAR(255) PRIMARY KEY,
        ...
        SERVERID VARCHAR(20),
        SERVERTYPE_ENUM_ID VARCHAR(255),
        VLAN VARCHAR(255)
);

CREATE TABLE SERVERTYPES_ENUM (
    SERVERTYPES_ENUM_ID VARCHAR(255) PRIMARY KEY,
    VALUE VARCHAR(255)
);
...
CREATE TABLE VERSIE (
    VERSIE_ID VARCHAR(255) PRIMARY KEY,
        AANTAL INTEGER,
